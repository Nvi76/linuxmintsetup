...
# Install Cliapps
sudo nala install -y figlet fish curl git vulkan-tools os-prober build-essential python3-tk python3-distutils-extra pipx mesa-utils wl-clipboard trash-cli papirus-icon-theme ulauncher; or exit 1
