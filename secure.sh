...
sudo nano /etc/fail2ban/jail.local && sudo systemctl restart fail2ban && sudo apt install nala figlet fail2ban clamav clamav-daemon gufw ufw && sudo nala install ./portmaster.deb
